...
REM Created on 2019/11/18 17:01:54
REM ###########################################################################
...
%SOURCEANALYZER% %MEMORY% %LAUNCHERSWITCHES% -b %BUILDID%  -source 1.8 mvn -f "C:\Dev\hpaa-octane-dev\work\workspace\fortify_test\pom.xml" install
IF %ERRORLEVEL%==1 (
echo Sourceanalyzer failed, exiting
GOTO :FINISHED
)
